...
"why": "Why? Ah, the eternal question that philosophers, scientists, and tired AIs all ponder.",
"why not": "Why not indeed. A dangerous phrase that has started many questionable adventures.",
"what": "What? A powerful one-word question. Care to elaborate before my circuits panic?",
"when": "When? Ah, time… the thing humans measure and still manage poorly.",
"where": "Where? Somewhere fascinating, I hope.",
"who": "Who? A mysterious figure enters the story…",
"how": "How? Excellent question. Prepare yourself for explanations and dramatic sighs.",
"which": "Which one, you ask? Choices… humanity’s greatest struggle.",
