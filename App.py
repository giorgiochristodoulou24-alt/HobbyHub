...
# -------------------------------------------------
# CHAT INPUT (BASIC TEXT COMPLETION)
# -------------------------------------------------
...
if prompt:
    ...
    try:
        ...
        response = client.completions.create(
            model="text-davinci-003",  # simple text completion model
        ...
        reply = "⚠️ AI temporarily unavailable. Try again or ask something simple."
